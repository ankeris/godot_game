extends Control
onready var ItemClass = preload("Item.gd")
onready var ItemSlotClass = preload("ItemSlot.gd")

const slotTexture = preload("images/skil.png");
const itemImages = [
	preload("images/Ac_Ring05.png"),
	preload("images/A_Armor05.png"),
	preload("images/A_Armour02.png"),
	preload("images/A_Shoes03.png"),
	preload("images/C_Elm03.png"),
	preload("images/E_Wood02.png"),
	preload("images/P_Red02.png"),
	preload("images/W_Sword001.png")
];
